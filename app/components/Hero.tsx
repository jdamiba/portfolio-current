...
export function Hero({ intro }: { intro: string }) {
  return (
    <section className="relative flex flex-col md:flex-row items-center md:items-stretch justify-center min-h-[60vh] md:min-h-[70vh] w-full gap-0 md:gap-8 px-2 md:px-0">
